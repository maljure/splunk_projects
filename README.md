...
| 03 | [FTP](./FTP_Analysis/Analysis.md) | Credential use, file transfers, anonymous access | ✅ Complete |
| 04 | [SSH](./SSH_Analysis/Analysis.md) | Reconnaissance, Lateral movement, and Credential attacks | ✅ Complete |
